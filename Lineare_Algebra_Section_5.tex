...
\[\mathrm{rk}T=\mathrm{dim}R(T)=\footnotemark\mathrm{dim}X-\mathrm{dim}R(T)^\bot =\mathrm{dim} X-\mathrm{dim}N(T')=\mathrm{dim}R(T')=\mathrm{rk}T'\]
\footnotetext{gilt wegen: $X=Y\oplus Y^\bot\\ \mathrm{dim}X=\mathrm{dim}Y+\mathrm{dim}Y^\bot$}
