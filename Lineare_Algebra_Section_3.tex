...
$l_{0,0}$ ist Isomorph zum Raum der Polynome $P(\mathbb{K}$ via den Isomorphismus $T\cdotC P(\mathbb{K})\rightarrow l_{0,0}$; $p\mapsto (\alpha _0,\cdots ,\alpha _n,0,\cdots 0,\cdots ): p=\sum_{k=0}^n\alpha _kt^k$
\end{enumerate}